...
class LandlineBillScreen extends StatefulWidget {
  const LandlineBillScreen({super.key});

  @override
  State<LandlineBillScreen> createState() => _LandlineBillScreenState();
}

class _LandlineBillScreenState extends State<LandlineBillScreen>
  ...
  Future<void> _query() async {
    if (_phoneCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('الرجاء إدخال رقم الهاتف الأرضي')));
      return;
    }
  ...
  Future<void> _downloadPdf() async {
    try {
          ...
          children: [
            pw.Container(
              ...
              decoration: pw.BoxDecoration(
                color: const PdfColor(0.30, 0.69, 0.31),
                borderRadius: pw.BorderRadius.circular(12),
              ),
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('إيصال دفع فاتورة الهاتف الأرضي',
            ...
            pw.Container(
              ...
              child: pw.Column(children: [
                ...
                _pdfDiv(),
                _pdfRow('المكالمات المحلية',     '${_billData['localCalls']!} مكالمة', txt),
                _pdfDiv(),
                _pdfRow('المكالمات الدولية',     '${_billData['intlCalls']!} مكالمة',  txt),
                _pdfDiv(),
                _pdfRow('إجمالي مدة الاستخدام', '${_billData['totalMinutes']!} دقيقة', txt),
                _pdfDiv(),
                _pdfRow('تاريخ الاستحقاق',      _billData['dueDate']!,           txt),
                _pdfDiv(),
                _pdfRow('رقم الهاتف',            _phoneCtrl.text.trim(),          txt),
                _pdfDiv(),
      ...
      final fileName = 'landline_receipt_$_refNo.pdf';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('فاتورة الهاتف الأرضي',
                ...
                Column(children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: done ? _green : current ? _lightGreen : Colors.white12,
        ...
        children: [
          Container(
            ...
            child: Row(children: [
              Container(
                width: 52, height: 52,
                decoration: BoxDecoration(
                  color: _lightGreen.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: const Icon(Icons.phone, color: _lightGreen, size: 28),
              ),
                ...
                children: [
                  Text('اتصالات سورية',
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          fontSize: 15)),
                  Text('الاستعلام عن فاتورة الهاتف الأرضي',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: '011 000 0000',
              hintStyle: const TextStyle(color: Colors.white24, letterSpacing: 2),
              filled: true,
              fillColor: _cardColor,
              prefixIcon: const Icon(Icons.phone_outlined, color: _lightGreen),
              border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(14),
                  borderSide: BorderSide.none),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide: BorderSide(color: _lightGreen.withValues(alpha: 0.6)),
              ),
            ),
          ),
          const SizedBox(height: 8),
          Center(
            child: Text('مثال: 011 234 5678',
                style: TextStyle(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  ...
                  const Text('فاتورة الهاتف الأرضي',
          ...
          Container(
            ...
            child: Column(children: [
              ...
              _divider(),
              _detailRow('رقم الهاتف',       _phoneCtrl.text.trim(), Icons.phone_outlined),
            ]),
          ),
          const SizedBox(height: 16),
          // إحصائيات المكالمات
          Container(
            decoration: BoxDecoration(
                color: _cardColor, borderRadius: BorderRadius.circular(20)),
            child: Column(children: [
              _detailRow('المكالمات المحلية',
                  '${_billData['localCalls']!} مكالمة', Icons.call_outlined),
              _divider(),
              _detailRow('المكالمات الدولية',
                  '${_billData['intlCalls']!} مكالمة', Icons.public_outlined),
              _divider(),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
                child: Row(children: [
                  Icon(Icons.timer_outlined, color: _lightGreen, size: 18),
                  const SizedBox(width: 12),
                  const Text('إجمالي مدة الاستخدام',
                  ...
                  Container(
                    ...
                    child: Text('${_billData['totalMinutes']!} دقيقة',
                        style: const TextStyle(
                            color: _lightGreen,
                            fontSize: 13,
                            fontWeight: FontWeight.bold)),
  ...
  Widget _detailRow(String label, String value, IconData icon) => Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        child: Row(children: [
          Icon(icon, color: _lightGreen, size: 18),
          const SizedBox(width: 12),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          const Text('تمت عملية دفع فاتورة الهاتف الأرضي',
              style: TextStyle(color: Colors.white54, fontSize: 13)),
          ...
          Container(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: 10),
              _receiptRow('إجمالي مدة الاستخدام', '${_billData['totalMinutes']!} دقيقة'),
            ]),
          ),
          const SizedBox(height: 24),
          SizedBox(
