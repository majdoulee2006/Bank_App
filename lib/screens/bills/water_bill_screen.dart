...
class _WaterBillScreenState extends State<WaterBillScreen>
  ...
  Future<void> _query() async {
    if (_subCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('الرجاء إدخال رقم الاشتراك')));
      return;
    }
  ...
  Future<void> _downloadPdf() async {
    try {
          ...
          children: [
            pw.Container(
              ...
              decoration: pw.BoxDecoration(
                color: const PdfColor(0.0, 0.74, 0.83),
                borderRadius: pw.BorderRadius.circular(12),
              ),
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('إيصال دفع فاتورة المياه',
            ...
            pw.Container(
              ...
              child: pw.Column(children: [
                ...
                _pdfDiv(),
                _pdfRow('القراءة السابقة',     '${_billData['prevReading']!} م³', txt),
                _pdfDiv(),
                _pdfRow('القراءة الحالية',     '${_billData['currReading']!} م³', txt),
                _pdfDiv(),
                _pdfRow('الكمية المستهلكة',   '${_billData['consumed']!} م³', txt),
                _pdfDiv(),
      ...
      final fileName = 'water_receipt_$_refNo.pdf';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('فاتورة المياه',
        ...
        children: [
          Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: const Icon(Icons.water_drop, color: _cyan, size: 28),
              ),
                ...
                children: [
                  Text('مياه سورية',
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          fontSize: 15)),
                  Text('الاستعلام عن فاتورة المياه',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.water_drop_outlined, color: _cyan),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [Color(0xFF006978), Color(0xFF00BCD4)],
          ...
          Container(
            ...
            child: Column(children: [
              ...
              _divider(),
              _detailRow('رقم الاشتراك',      _subCtrl.text.trim(),  Icons.water_drop_outlined),
            ]),
          ),
          const SizedBox(height: 16),
          // قراءات العداد
          Container(
            decoration: BoxDecoration(
                color: _cardColor, borderRadius: BorderRadius.circular(20)),
            child: Column(children: [
              _detailRow('القراءة السابقة',
                  '${_billData['prevReading']!} م³', Icons.speed_outlined),
              _divider(),
              _detailRow('القراءة الحالية',
                  '${_billData['currReading']!} م³', Icons.speed),
              _divider(),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
                child: Row(children: [
                  Icon(Icons.water_drop, color: _cyan, size: 18),
                  ...
                  Container(
                    ...
                    child: Text('${_billData['consumed']!} م³',
                        style: const TextStyle(
                            color: _cyan,
                            fontSize: 13,
                            fontWeight: FontWeight.bold)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          const Text('تمت عملية دفع فاتورة المياه',
              style: TextStyle(color: Colors.white54, fontSize: 13)),
          ...
          Container(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: 10),
              _receiptRow('الكمية المستهلكة', '${_billData['consumed']!} م³'),
            ]),
          ),
          const SizedBox(height: 24),
          SizedBox(
