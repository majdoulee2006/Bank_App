...
class _ElectricityBillScreenState extends State<ElectricityBillScreen>
  ...
  Future<void> _query() async {
    if (_meterCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('الرجاء إدخال رقم العداد')));
      return;
    }
  ...
  Future<void> _downloadPdf() async {
    try {
          ...
          children: [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text('إيصال دفع فاتورة الكهرباء',
            ...
            pw.Container(
              ...
              child: pw.Column(children: [
                _pdfRow2('الرقم المرجعي',    _refNo,                    txt),
                _pdfDiv(),
                _pdfRow2('اسم المشترك',     _billData['name']!,        txt),
                _pdfDiv(),
                _pdfRow2('رقم الفاتورة',    _billData['billNo']!,      txt),
                _pdfDiv(),
                _pdfRow2('الفترة',          _billData['period']!,      txt),
                _pdfDiv(),
                _pdfRow2('تاريخ الاستحقاق', _billData['dueDate']!,    txt),
                _pdfDiv(),
                _pdfRow2('رقم العداد',      _meterCtrl.text.trim(),    txt),
                _pdfDiv(),
                _pdfRow2('التاريخ والوقت',  _payTime,                  txt),
              ]),
            ),
      ...
      final fileName = 'electricity_receipt_$_refNo.pdf';
  ...
  pw.Widget _pdfRow2(String label, String value,
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('فاتورة الكهرباء',
              style: TextStyle(
                ...
                children: [
                  Text('كهرباء سورية',
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          fontSize: 15)),
                  Text('الاستعلام عن فاتورة الكهرباء',
                      style: TextStyle(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide:
                    BorderSide(color: _purple.withValues(alpha: 0.6)),
              ),
            ),
          ),
        ...
        children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              _divider(),
              _detailRow('رقم العداد',       _meterCtrl.text.trim(), Icons.power_outlined),
            ]),
          ),
          ...
          TextButton(
            ...
            child: const Text('تعديل رقم العداد',
        ...
        children: [
          ...
          const Text('تم الدفع بنجاح!',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          const Text('تمت عملية دفع فاتورة الكهرباء',
